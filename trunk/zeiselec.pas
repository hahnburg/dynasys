...
type
  TZeitkurveDlg = class(TForm)
    ...
    procedure ZeitSetClick(Sender: TObject);
...
procedure TZeitkurveDlg.ZeitSetClick(Sender: TObject);
begin
...
procedure TZeitkurveDlg.MoveSelected(List: TCustomListBox; Items: TStrings);
var
  I: Integer;
begin
